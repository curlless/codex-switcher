...
use crate::switcher::{Paths, UpdateCache, lock_usage, read_profiles_index, write_profiles_index};
...
const LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/curlless/codex-switcher/releases/latest";
const RELEASE_NOTES_URL: &str = "https://github.com/curlless/codex-switcher/releases/latest";
...
mod tests {
    use super::*;
    use crate::switcher::test_utils::{ENV_MUTEX, http_ok_response, set_env_guard, spawn_server};
    use std::fs;
    use std::path::PathBuf;
